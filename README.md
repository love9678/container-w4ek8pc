...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w4ek8pc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w4ek8pc.containers.anotherwebservice.com/
...
```
git clone git@github.com:love9678/container-w4ek8pc.git
cd container-w4ek8pc
```
...
```
docker attach container-w4ek8pc
```
